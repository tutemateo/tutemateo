export function ContactForm() {
  ...
  <legend>Send me your comments</legend>
      <input
        ...
        name="name"
        placeholder="Name"
        title="Nombre solo acepta eltra y espacios en blanco"
      ...
      <div class="contact-form-loader none">
        <img
          src="/Assets/SVG-Loaders-master/svg-loaders/tail-spin.svg"
          alt="cargando"
        />
      </div>
  ...
  function validationsForms() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/fmateo25596@gmail.com", {
        method: "POST",
  ...
  setTimeout(() => validationsForms(), 100);
